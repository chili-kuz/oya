...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=150mm]{fig/input.eps}
        \caption{入力$u(t)$}
        \label{fig:input}
    \end{center}
 \end{figure}
...
た結果を示す．ただし，$\eta_\alpha=\eta_\beta=\eta_\gamma=1$とした．
%
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/x_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/x_tilde_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/u_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/alpha_h_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/beta_h_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/gamma_h_rd4.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/x_rdsin.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/x_tilde_rdsin.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/u_rdsin.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/alpha_h_rdsin.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/beta_h_rdsin.eps}
...
\begin{figure}[htb]
    \begin{center}
       \includegraphics[width=170mm]{fig/gamma_h_rdsin.eps}
